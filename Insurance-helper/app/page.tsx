  ...
  return (
    <div className="mx-auto max-w-6xl p-4 md:p-8">
      <header className="flex items-center gap-3 mb-4 flex-wrap">
        ...
        <h1 className="text-2xl font-semibold">Insurance Helper</h1>
              ...
              {parsedPDFs.length > 0 && (
                <div className="mt-4 space-y-3">
                  ...
                  <div className="text-xs opacity-70 pt-2 border-t">
                    Your insurance documents are parsed locally and never uploaded. Your privacy is protected.
                  </div>
                </div>
              )}
            </CardContent>
            ...
            <CardContent className="flex-1 flex flex-col gap-2 min-h-0">
              ...
              <div className="flex-shrink-0">
                ...
                <div className="text-xs opacity-60 text-center mt-2">
                  AI-powered insurance guidance. This is not legal or medical advice. Always verify with your insurance provider.
                </div>
              </div>
            </CardContent>
          </Card>
