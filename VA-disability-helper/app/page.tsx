...
import { Bot, Database, FileText, X, Shield } from "lucide-react";
...
export default function HomePage() {
  ...
  const ragTopK = 12; // Maximum retrieval for best information
  ...
  const handleSend = useCallback(
    ...
    [useLocalDocs, parsedPDFs, sessionId, ragTopK]
  );
  ...
  return (
    <div className="mx-auto max-w-6xl p-4 md:p-8">
      <header className="flex items-center gap-3 mb-4 flex-wrap">
        ...
        <h1 className="text-2xl font-semibold">VA Disability Helper</h1>
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground mb-3">
                Upload your VA decision letters, medical records, C&P exam results, or other VA documents.
              </p>
              ...
              {parsedPDFs.length > 0 && (
                <div className="mt-4 space-y-3">
                  ...
                  <div className="text-xs opacity-70 pt-2 border-t">
                    Your VA documents are parsed locally and never uploaded. Your privacy is protected.
                  </div>
                </div>
              )}
            </CardContent>
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent className="space-y-2 text-xs">
              <div className="p-2 bg-muted/50 rounded">
                What percentage can I get for PTSD with nightmares?
              </div>
              <div className="p-2 bg-muted/50 rounded">
                How do I prove service connection without service records?
              </div>
              <div className="p-2 bg-muted/50 rounded">
        ...
        <div className="lg:col-span-9">
          <Card className="rounded-2xl h-[calc(100vh-12rem)] flex flex-col">
            <CardHeader className="pb-2 flex-shrink-0">
              <CardTitle className="flex items-center gap-2 text-lg">
                Chat with VA Disability Assistant
              </CardTitle>
            </CardHeader>
            <CardContent className="flex-1 flex flex-col gap-2 min-h-0">
              <MessageList messages={messages} />
              <div className="flex-shrink-0">
                <Composer onSend={handleSend} onClearChat={handleClearChat} disabled={pending} />
                <div className="text-xs opacity-60 text-center mt-2">
                  AI-powered VA disability guidance. This is not legal advice. Always verify with a VSO or VA-accredited attorney.
                </div>
              </div>
            </CardContent>
          </Card>
